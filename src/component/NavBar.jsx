...
const NavBar = () => {
    ...
    return (
        <>
            <div className=" fixed top-0  z-10 w-full flex  justify-center  bg-white shadow-[0_3px_10px_rgb(0,0,0,0.2)]" >
                <div className='wrapper-container w-full'>
                    <div className=" flex flex-row justify-between py-5 px-5 ">
                        <Link to={'/'} className=" flex flex-col items-center cursor-pointer">
                            <PaidIcon fontSize="large" sx={{ color: "green" }} />
                        ...
                        <nav className="lg:flex flex-row items-center text-lg font-medium gap-8 md:ml-0 ml-8 ">
                            ...
                            <Link to={user ? '/market' : '/login'}
                                className="hover:text-[#004225] transition-all cursor-pointer mr-4 "
                            >
                                Market
                            </Link>
                            <Link to={user ? '/trending' : '/login'}
                                className="hover:text-[#004225] transition-all cursor-pointer mr-4 "
                            >
                                Trending
                            </Link>
